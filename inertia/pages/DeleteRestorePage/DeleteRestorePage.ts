...
class DeleteRestore {
  ...
  async DeleteRestore() {
    ...
    const restoreMenuItem = Selector("li.ant-dropdown-menu-item")
      .find("span.ant-dropdown-menu-title-content")
      .withText("Restore")
      .parent();
    await t
      .expect(restoreMenuItem.exists)
      .ok("Không tìm thấy tùy chọn Restore")
      .click(restoreMenuItem)
      .wait(2000);
  }
}

export default new DeleteRestore();
